...
```bash
PHASE_INFO=$(node /home/ummar/.claude/get-shit-done/bin/gsd-tools.cjs find-phase "${PHASE}")
```
...
```bash
PHASE_CHECK=$(node /home/ummar/.claude/get-shit-done/bin/gsd-tools.cjs roadmap get-phase "${PHASE}")
...
```bash
PHASE_DIR=$(node /home/ummar/.claude/get-shit-done/bin/gsd-tools.cjs find-phase "${PHASE}" --raw)
```
